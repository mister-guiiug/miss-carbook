...
export const CRITERIA: {
  ...
  {
    key: 'trunkLiters',
    label: candidateSpecLabels.trunkLiters,
    path: 'spec',
    numeric: true,
  },
  {
  ...
  {
    key: 'powerKw',
    label: candidateSpecLabels.powerKw,
    path: 'spec',
    numeric: true,
  },
  {
    key: 'lengthMm',
    label: candidateSpecLabels.lengthMm,
    path: 'spec',
    numeric: true,
  },
  {
    key: 'widthMm',
    label: candidateSpecLabels.widthMm,
    path: 'spec',
    numeric: true,
  },
  {
    key: 'heightMm',
    label: candidateSpecLabels.heightMm,
    path: 'spec',
    numeric: true,
  },
  {
    key: 'wheelbaseMm',
    label: candidateSpecLabels.wheelbaseMm,
    path: 'spec',
    numeric: true,
  },
  {
    key: 'co2Gkm',
    label: candidateSpecLabels.co2Gkm,
    path: 'spec',
    numeric: true,
  },
];

export const COMPARE_RADAR_COLORS = [
  '#0f766e',
  '#7c3aed',
  '#ea580c',
  '#2563eb',
