...
export function PhotoComparisonGrid({
  ...
  const handleNextPhoto = useCallback(
    (candidateId: string, photosLength: number) => {
  ...
  const handlePrevPhoto = useCallback(
    (candidateId: string, photosLength: number) => {
      setPhotoIndexes(prev => {
        ...
        return {
          ...prev,
          [candidateId]: current === 0 ? photosLength - 1 : current - 1,
        };
      });
    },
    []
  ...
  if (!hasAnyPhotos) {
    return (
      ...
      >
        <div
          className="photo-comparison-container"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Contrôles */}
        <div
          className="photo-comparison-controls card"
        ...
        >
          {candidatesWithPhotos.map(candidate => {
            ...
            const currentPhoto = hasPhotos
              ? photos[candidate.currentPhotoIndex]
              : null;
